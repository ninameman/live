...
1.  配置转码模板。
    -   配置通用转码
        ...
        4.  在 **转码模板配置** 中，选择 **通用转码**，并单击 **添加**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/64903/155011614532853_zh-CN.png)

        5.  输入转码模板参数。您可以根据配置选择对应模板ID。

            窄带高清™模板

            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/64903/155011614632864_zh-CN.png)
    ...
    -   配置自定义转码
        ...
        4.  在 **转码模板配置** 中，选择 **自定义转码**，并单击 **添加**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23686/155011614637640_zh-CN.png)

        5.  输入转码模板参数。您可以根据配置选择对应模板ID。

            窄带高清™模板

            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/64903/155011614632865_zh-CN.png)
