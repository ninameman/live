...
2. 新建工程：![新建工程2](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169000.png)

   

3. 创建完成后，项目目录结构如图所示：![项目结构](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169003.png)

   

4. 在根目录的`build.gradle`中添加如下代码:![gradle](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169004.png)
...
1. 修改`ijkplayer/init-android.sh`中`pull_fork`只保留armv7a和arm64， 并执行该脚本。
   ...
   **说明**
   ...
   ![ijk-图1](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169013.png)
   

2. 修改`ijkplayer/Android/contrib/compile-ffmpeg.sh`中`FF_ACT_ARCHS_64`，只保留armv7a和 arm64。![c2](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169014.png)
...
4. 修改Makefile，编译rtsdec.c。
   ...
   修改`ijkplayer/android/contrib/ffmpeg-arm64/libavformat/Makefile`和`ijkplayer/android/contrib/ffmpeg-arm64/libavformat/Makefile`，如下图：![1](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/6416775061/p183914.png)
   

5. 修改allformat.c 默认支持ARTC协议。

   修改`ijkplayer/android/contrib/ffmpeg-arm64/libavformat/allformats.c`和`ijkplayer/android/contrib/ffmpeg-arm64/libavformat/allformats.c`，如下图：![c6](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169016.png)
...
9. ijkplayer 依赖 rts。
   ...
   修改`ijkplayer/Android/compile-ijk.sh`，ACT_ABI_64中只保留armv7a和arm64 。如下图：![c7](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169017.png)
...
11. 引入RTS的动态库。
    ...
    `修改ijkplayer/android/ijkplayer/ijkplayer-armv7a/src/main/jni/ffmpeg/Android.mk`和`ijkplayer/android/ijkplayer/ijkplayer-arm64/src/main/jni/ffmpeg/Android.mk`。如下图：![c8](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169018.png)
...
12. ijkplayer依赖RTS动态库。
    ...
    修改`ijkplayer/ijkmedia/ijkplayer/Android.m`。如下图：![c9](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/0990770061/p169019.png)
    

13. ff_fflay.c中加入RTS逻辑。

    设置给artc的AVInputFormat函数指针。修改`ijkplayer/ijkmedia/ijkplayer/ff_ffplay.c`。如下图：![c10](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169021.png)
...
3. ff_fflay.c中加入RTS逻辑
   ...
   区分ARTC协议头，使用指定的AVInputFormat。如下图：![c11](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169053.png)
...
如图所示：![j1](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169060.png)
...
* 如果采用 **本地依赖方式** ，则将如下库文件拖到项目中，并在target的 **Gennel** 栏将framework设置为Embed \& Sign。
  ...
  ![j2](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169248.png)![j3](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169250.png)
...
2. 进入`ijkplayer/ios`目录，将`rtsdec.c`拷贝到`ffmpeg-$arch/libavformat`中，修改`libavformat/Makefile`和`allformat.c`。参考Android方法一中的该步骤。
...
7. `IJKMediaPlayer.xcodeproj`添加`RtsSDK.framework`的依赖。![j4](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169264.png)
...
3. 将rtsdec.c 拖入到工程中。![j5](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169270.png)
...
![j6](//static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/1990770061/p169273.png)
